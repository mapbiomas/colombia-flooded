 ...
 * STEP 04-5: FREQUENCY FILTER (CLASS 6)
 * ==============================================================================
 * @version       1.0
 * @update        March 2026
 ...
 *                Within the applyArea, remaining class 6 pixels that failed the
 *                frequency threshold are reassigned to 27 (non-flooded).
 * @inputs        - Temporally filtered classification (clasificacion-ft/)
...
Map.add(ui.Label('Flooded Col3 - Freq Filter Class 6 - Region ' + param.regionCode, {
