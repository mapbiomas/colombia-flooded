 ...
 * STEP 04-7: REMAP FILTER
 * ==============================================================================
 * @version       1.0
 * @update        March 2026
 * @attribution   MapBiomas Colombia (Fundacion Gaia Amazonas)
 * @description   Applies a low-threshold frequency filter (majorityPercent) to
 *                confirm flooded (6) pixels, then applies polygon-based class
 *                remapping. This step follows the class 27 frequency filter and
 *                serves as a final correction pass. Supports year exclusions, an
 *                optional spatial area restriction (applyArea), and polygon remap
 *                geometries. Within the applyArea, class 6 pixels that fail the
 *                frequency threshold are reassigned to 27 (non-flooded).
 * @inputs        - Frequency-filtered class 27 classification (clasificacion-ft/)
 * @outputs       - Earth Engine Asset: remap-filtered classification image saved
 *                  to 'COLLECTION3/CROSS_CUTTING/FLOODED/clasificacion-ft/'
...
Map.add(ui.Label('Flooded Col3 - Remap Filter - Region ' + param.regionCode, {
