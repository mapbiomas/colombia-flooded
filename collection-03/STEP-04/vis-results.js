...
var param = {
  ...
  versionInput:  '5',    // Version of the output to load
...
var assets = {
  ...
  maskROI:          basePath + 'LULC/COLLECTION3/CROSS_CUTTING/FLOODED/STEP1_REGIONS/classification_mask/FLOODED-ROI-' + param.country + '-' + param.regionCode + '-1',
